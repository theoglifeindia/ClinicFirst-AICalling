    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 transition-colors">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-3.5 py-2 theme-btn-primary text-xs sm:text-sm font-semibold rounded-xl shadow-xs transition-colors cursor-pointer"
        >
      ...
      {/* Search Filter */}
      <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs flex items-center gap-3 transition-colors">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs overflow-hidden transition-colors">
        {loading ? (
          ...
          <div className="p-12 text-center text-slate-500 dark:text-slate-400">
            ...
            <p className="text-sm font-semibold text-slate-700 dark:text-slate-200">No patients found</p>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs">
              <thead>
                <tr className="bg-slate-50/80 dark:bg-slate-800/60 border-b border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 font-mono">
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                {filteredPatients.map((patient) => {
                  ...
                  return (
                    <tr key={patient.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/40 transition-colors">
                      <td className="py-3.5 px-4">
                        <div className="flex items-center gap-2.5">
                          <div className="w-8 h-8 rounded-full bg-emerald-50 dark:bg-emerald-950/60 text-[#008768] dark:text-emerald-400 font-bold flex items-center justify-center text-xs">
                      ...
                      <td className="py-3.5 px-4">
                        <span className="px-2 py-0.5 rounded-full text-2xs font-mono font-bold bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700">
                      ...
                      <td className="py-3.5 px-4 text-right">
                        <button
                          onClick={() => onOpenBooking()}
                          className="px-2.5 py-1 text-2xs font-semibold text-[#008768] dark:text-emerald-300 hover:bg-emerald-50 dark:hover:bg-emerald-950/50 border border-emerald-200 dark:border-emerald-800 rounded-lg transition-colors cursor-pointer"
                        >
                          Book Visit
                        </button>
                      </td>
